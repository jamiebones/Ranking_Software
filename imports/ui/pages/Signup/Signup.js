...
class Signup extends React.Component {
  ...
  handleSubmit() {
    ...
    const options = {email: this.emailAddress.value,
  ...
  render() {
    return (<div className="Signup">
      <Row>
        <Col xs={12} sm={6} md={5} lg={4} smOffset={3} md={5} mdOffset={5} lg={4} lgOffset={4}>
          <h4 className="page-header">Register Account</h4>
          
          <form ref={form => (this.form = form)} onSubmit={event => event.preventDefault()}>
            <FormGroup>
              <ControlLabel>Title</ControlLabel>
                <select className="form-control title"
            ...
            <Button type="submit" bsStyle="success" disabled={this.state.submitted}>
                { this.state.submitted ? ( "Creating account please wait------" ) : "Sign Up" }
            </Button>
            <AccountPageFooter>
