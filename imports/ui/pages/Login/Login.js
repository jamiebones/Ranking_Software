...
class Login extends React.Component {
  ...
  render() {
    return (<div className="Login">
      <Row>
        <Col xs={12} sm={6} smOffset={3} md={5} mdOffset={5} lg={4} lgOffset={4}>
     ...
     <Row>
      <Col xs={12} sm={6} smOffset={3} md={5} 
         mdOffset={5} lg={4} lgOffset={4}>
          { this.state.submitted ? ( 
             <Alert bsStyle="info">
                 <p className="text-center">
                    Logging user <b>{ this.state.userEmail }</b> into 
